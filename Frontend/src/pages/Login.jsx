...
import logoWhite from '../assets/media/pictures/logo_white.png'; 
import logoOnly from '../assets/media/pictures/only_logo_white.png'; 
...
const Login = () => {
  ...
  return (
    <form className="container flex items-center justify-center rounded-xl" onSubmit={handleSubmit(onSubmit)}>
      <div className="left shadow-xl flex-col justify-center items-center h-[24.7rem] z-10 rounded-lg overflow-hidden bg-gray-100 mr-3 hidden md:flex">
        ...
        <div className="contact_us flex h-1/4 bg-gray-100 justify-center items-center space-x-5">
          ...
          <a className="h-1/3" href="#">
            <img className="h-full" src={linkedinIcon} alt="LinkedIn" />
          </a>
          <a className="h-1/3" href="#">
            <img className="h-full" src={mailIcon} alt="Email" />
          </a>
          <a className="h-1/3" href="#">
            <img className="h-full mix-blend-multiply" src={logoOnly} alt="Logo" />
          </a>
          <a className="h-1/3 fill-black" href="#">
            <img className="h-full" src={phoneIcon} alt="Phone" />
          </a>
        </div>
      </div>
      <div className="right flex flex-col p-5 bg-gray-100 rounded-md shadow-xl w-80 h-[26.7rem] min-w-96 md:h-[24.7rem]">
        ...
        <button className="flex justify-center my-3 items-center py-1 rounded-lg bg-gray-200">
          <img src={googleIcon} className="w-8 mr-2" alt="Google" />
          Log In with Google
        </button>
        <p className="m-auto">
