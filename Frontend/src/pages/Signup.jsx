...
import googleIcon from '../assets/media/icons/google.svg';
import githubIcon from '../assets/media/icons/github_light.svg';
import linkedinIcon from '../assets/media/icons/linkedin_light.svg';
import mailIcon from '../assets/media/icons/mail_light.svg';
import phoneIcon from '../assets/media/icons/phone_light.svg';
import logo from '../assets/media/pictures/logo_white.png';
import smallLogo from '../assets/media/pictures/only_logo_white.png';
    ...
    <div className="container flex items-center justify-center rounded-xl">
      <div className="left shadow-xl flex-col justify-center items-center h-[32.7rem] z-10 rounded-lg overflow-hidden bg-gray-100 mr-3 hidden md:flex">
        <div className="logo bg-gray-100 overflow-hidden h-3/4 flex justify-center items-center">
          <img src={logo} className="object-contain mr-8 min-h-[500px] mix-blend-multiply" alt="logo_not_found" />
        </div>
        <div className="contact_us flex h-1/4 bg-gray-100 justify-center items-center space-x-5">
          <a className="h-1/3" href=""><img className="h-full" src={githubIcon} alt="git" /></a>
          <a className="h-1/3" href=""><img className="h-full" src={linkedinIcon} alt="linkedin" /></a>
          <a className="h-1/3" href=""><img className="h-full" src={mailIcon} alt="mail" /></a>
          <a className="h-1/3" href=""><img className="h-full mix-blend-multiply" src={smallLogo} alt="small_logo" /></a>
          <a className="h-1/3" href=""><img className="h-full" src={phoneIcon} alt="phone" /></a>
        </div>
      </div>
      ...
      <div className="right flex flex-col p-5 bg-gray-100 rounded-md shadow-xl w-80 h-[35.7rem] min-w-96 md:h-[32.7rem]">
        ...
        <button className="flex justify-center my-3 items-center py-1 rounded-lg bg-gray-200">
          <img src={googleIcon} className="w-8 mr-2" alt="google" /> Sign Up with Google
        </button>
        ...
        <div className="contact_us flex h-1/4 bg-gray-100 justify-center items-center space-x-5 md:hidden">
          <a className="h-1/3" href=""><img className="h-full" src={githubIcon} alt="github" /></a>
          <a className="h-1/3" href=""><img className="h-full" src={linkedinIcon} alt="linkedin" /></a>
          <a className="h-1/3" href=""><img className="h-full" src={mailIcon} alt="mail" /></a>
          <a className="h-1/3" href=""><img className="h-full mix-blend-multiply" src={smallLogo} alt="small_logo" /></a>
          <a className="h-1/3" href=""><img className="h-full" src={phoneIcon} alt="phone" /></a>
